...
const servicesData = {
  "life-cover": {
    title: "Life Cover",
    intro: "Life cover pays a lump sum to your family if you die during the policy term. It is one of the simplest ways to make sure that, if the worst happens, the people who depend on you are not left struggling financially.",
    covers: [
  ...
  "critical-illness": {
    ...
    intro: "Critical illness cover pays a tax-free lump sum if you are diagnosed with one of a list of specified serious conditions. Unlike life insurance, it pays out while you are still alive, giving you financial breathing room when you need it most.",
    covers: [
  ...
  "income-protection": {
    ...
    intro: "Income protection pays a regular income if you are unable to work due to illness or injury. It is designed to cover the gap between what you earn and what you would receive from statutory or employer sick pay.",
    covers: [
      ...
      "The deferred period (how long before it kicks in) and benefit period are agreed when you take out the policy"
    ],
  ...
  "mortgage-broker": {
    ...
    intro: "Finding the right mortgage is rarely straightforward. Rates change, lender criteria differ, and the deal you can get depends on your specific circumstances. Anthony searches the mortgage market on your behalf to find an option that fits.",
    covers: [
  ...
  "mortgage-protection": {
    ...
    intro: "Mortgage protection insurance is designed to pay off your outstanding mortgage balance if you die during the term of your loan. It means your family keeps the home even if you are no longer there to make the payments.",
    covers: [
  ...
  "home-insurance": {
    ...
    intro: "Home insurance covers the cost of repairing or rebuilding your home and replacing your belongings if something goes wrong. Most mortgage lenders require buildings insurance as a condition of your loan.",
    covers: [
...
export default function ServicePage({ params }: { params: { id: string } }) {
  ...
  if (!service) {
    return (
      <div className="py-24 text-center">
        ...
        <Link href="/" className="text-gold mt-4 inline-block">Return home</Link>
      </div>
    );
  }
  ...
  return (
    <>
      ...
      <div className="py-24 bg-surface min-h-[70vh]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link href="/#services" className="text-sm font-semibold text-gray-500 hover:text-gold mb-8 inline-block transition-colors">
          ...
          <p className="text-xl text-gray-800 leading-relaxed mb-12 border-l-4 border-gold pl-6">
            {service.intro}
          </p>
          
          <div className="mb-12">
            <h2 className="text-2xl font-serif text-navy mb-6">What it covers</h2>
            <ul className="space-y-4">
              {service.covers.map((point, i) => (
                <li key={i} className="flex items-start">
                  <span className="text-gold mr-3 mt-1 text-xl leading-none">&bull;</span>
          ...
          <div className="mb-12">
            <h2 className="text-2xl font-serif text-navy mb-4">Who it's for</h2>
            <p className="text-gray-700 leading-relaxed">{service.who}</p>
          </div>
          
          <div className="mb-16">
            <h2 className="text-2xl font-serif text-navy mb-4">How A&L helps</h2>
            <p className="text-gray-700 leading-relaxed">{service.how}</p>
          </div>
          
          <div className="pt-8 border-t border-gray-200">
            <Link 
              href="/contact" 
              className="inline-block bg-navy text-white font-semibold px-8 py-4 rounded-sm hover:bg-gray-900 transition-colors"
            >
